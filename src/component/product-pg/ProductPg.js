...
<input className='searchbox' type='search' placeholder={props.placeholder}  onChange={event=>{setsearchTerm(event.target.value)}}/>
    ...
    <li className='product-list-item'><a href='#'>NAME</a></li>
    <li className='product-list-item'><a href='#'>RATING</a></li>
    <li className='product-list-item'><a href='#'>PRICE</a></li>
    <li className='product-list-item'><a href='#'>CUISINE</a></li>
...
<img  className='pr-image' src={postMessage.image}/>
        ...
        <div className='product-details'>
            <p className='restaurantname'>{postMessage.restaurantName}</p>
            <p className='location'><i class="fas fa-map-marker-alt"></i>{postMessage.location}</p>
        ...
        <img width={100} src={require('../../Assest/images/rating.png')}/>
        <p className='review'>({postMessage.review} reviews) </p>
        <p className='avg-price'>Average price</p>
        <h3 className='pricepd'>${postMessage.minprice} - ${postMessage.maxprice}</h3>
...
<ul className='pages'>
<li className='page-no active6'><a href=''>1</a></li>
<li className='page-no'><a href=''>2</a></li>
<li className='page-no'><a href=''>3</a></li>
<li className='page-no'><a href=''>4</a></li>
<li className='page-no'><a href=''>5</a></li>
</ul>
