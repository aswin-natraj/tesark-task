  ...
  return (
    <div className="footer-container">
      <div className="footer-describe">
        <p className="footer-describe-head">
          <i class="fas fa-utensils"></i>FindTable
        </p>
        <p>
          ...
          many restaurants also offer take-out and food delivery service and ...
          <a href="#" className="semore">
            See more
          </a>
        </p>
      </div>
      <div className="footer-sub-detail">
        ...
        <div className="footer-sub-main">
          <div className="company">
            <li className="company-list-item active11">
              <a href="#">COMPANY</a>
            </li>
